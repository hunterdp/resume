...
\section{\textbf{Experience}}
    \resumeHeadingListStart
        \resumeCompanyHeading {Hunter 23 Technology}{Mountain View, CA}{CEO}{Jan 2022 - present}
          \resumeJobDescription {A trusted advisory to early, mid-stage start ups and enterprise companies specializing in strategy development, market analysis,
                                  program management and technical due-dilligence in the enterprise IT market.}

        \resumeCompanyHeading
          {Hewlett Packard Enterprise}
          {San Jose, CA}
          {Vice President Engineering \& CTO for Strategy, Hewlett Packard Labs}
          {Mar 2015 - present}
            \resumeItemListStart
