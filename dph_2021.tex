...
\section{\textbf{Experience}}
    \resumeHeadingListStart
        \resumeCompanyHeading
          ...
          {San Jose, CA}
          {Vice President \& Chief Technologist, Hewlett Packard Labs}
          {Mar 2015 - present}
            \resumeItemListStart
        ...
        \resumeCompanyPositionHeading
          {Hardware Engineer, Laboratory Data Products}{Jun 1983 - Aug 1986}
            \resumeItemListStart
                ...
                \resumeItem{Laboratory Information Management Systems}{Developed software and API library set for graphing data from various laboratory
...
\section{\textbf{Patents}}
    \resumeHeadingListStart
        \resumeItemListStart
            \resumeItem{US 6470493}{Computer method and apparatus for safe instrumentation of reverse executable program modules.}
            \resumeItem{US 6115550}{Loader conditionally replacing a code sequence with a functionally-alike code sequence in an executable program intended for 
                        execution indifferent run-time environments.}
            \resumeItem{US 6470493}{Computer method and apparatus for safe instrumentation of reverse executable program modules.}
            \resumeItem{US 5920721}{Compiler generating functionally-alike code sequences in an executable program intended for execution in different run-time environments.}
        \resumeItemListEnd
\resumeHeadingListEnd
