...
\newcommand{\resumeEducationSubheading}[3]{
  ...
  \newcommand{\resumeVolunteerSubheading}[2]{
    \item 
      \vspace{-5pt}
      \begin{tabular*}{1.0\textwidth}[t]{l@{\extracolsep{\fill}}r}
        #1 & #2
...
\section{\textbf{Experience}}
    \resumeSubHeadingListStart
        \resumeSubheading
          ...
          {San Jose, CA}
          {Vice President \& Chief Strategist, Hewlett Packard Labs}
          {Nov 2019 - present}
            \resumeItemListStart
                \resumeItem{Management}{Team of program managers and strategist to support research programs \& projects.}
                \resumeItem{Play to Win Strategy}{Disruptive Development, High Performance Computing \& Trustworthy AI strategies.}
                ...
                \resumeItem{Internal Advisory Board}{Board of GM level business \& technical experts to advise on research activities.}
            \resumeItemListEnd

        \resumeSubSubheading
          {Vice President \& Chief Technologist, Software Defined Cloud Business Group}
          {Mar 2014 - Oct 2019}
            \resumeItemListStart
                \resumeItem{Landscape Charts}{....}
                \resumeItem{Pathfinder Investments}{Platform9}
                \resumeItem{Acquisitions}{Simplivity, QuattroNetworks, Plexxi}
                \resumeItem{Cloud Brokering}{...}
...
\section{\textbf{Volunteer Efforts}}
    \resumeSubHeadingListStart
    \resumeVolunteerSubheading{Trustee, Naval War College Foundation}{2018 - present}
    \resumeVolunteerSubheading{Northeastern University, College of Electrical \& Computer Engineering Advisory Board}{2006 - present}
    \resumeVolunteerSubheading{National University, Cyber Security and Information Assurance Advisory Council}{2010 - 2013}
    \resumeVolunteerSubheading{U.S. Secretary of the Navy, National Naval Reserve Forces Policy Board}{2005 - 2008}
  \resumeSubHeadingListEnd
  \vspace{5pt}
%-----------EDUCATION-----------------
